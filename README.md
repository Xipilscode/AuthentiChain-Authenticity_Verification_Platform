    ...
    AuthentiChain is a Python application that demonstrates how blockchain technology can be utilized to verify the authenticity of products in a supply chain. The application was developed using Python, Streamlit, and Web3.
    ...
    The manufacturer page allows a user to input product details (name and description) and generate a unique QR code that represents the product. Once the "Generate QR Code" button is pressed, a QR code is generated and displayed.
    ...
    To visualize the preprocessing steps and perform the ADF test, click on the corresponding buttons provided.
